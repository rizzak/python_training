...
def test_add_contact(app):
    ...
    contact = Contact(first_name="Vasya", middle_name="Ivanovich", last_name="Petrov", nickname="Bublik",
                      ...
                      work_tel="3434332", fax="4635463", email="bublik@mail.ru", homepage="bublik.com", birthday="1986",
                      anniversary="2000", secondary_address="Mayskaya, 3", secondary_tel="Home", notes="Moy kontakt")
