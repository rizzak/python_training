...
class Contact:
    ...
    def __eq__(self, other):
        return (self.id is None or other.id is None or self.id == other.id) and (self.first_name is None or self.first_name == other.first_name) and (self.last_name is None or self.last_name == other.last_name)
